...
product2 = Product.create(title: "Reclaimed Wood & Steel Desk - Wood Office Desk", image: "https://t3.ftcdn.net/jpg/10/51/36/02/360_F_1051360205_TEHnKe0NqsVc3wirIvcs8U1evXnCrKaN.jpg", price: 175.25, description: "This table is handcrafted with reclaimed wood.")
product3 = Product.create(title: "Wood Table Lamp", image: "https://img.freepik.com/premium-photo/minimalist-lamp-with-subtle-curves-plain-white-bg_1264082-16665.jpg?w=2000", price: 112.45, description: "Table lamp provides warm lighting.")
