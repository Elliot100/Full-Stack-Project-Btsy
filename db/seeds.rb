...
product1 = Product.create(title: "Minimalist Leather Wallet", image: "https://media.istockphoto.com/photos/leather-minimalist-wallet-picture-id916776140?k=20&m=916776140&s=170667a&w=0&h=_GqFjqKp8_LP5_FFeMapbVFzMw7UMxEyiWNhLQYMasE=", price: 32.00, description: "Minimalist Leather Wallet, Pop Up Credit Card Wallet,Unisex Wallet")
product2 = Product.create(title: "Reclaimed Wood & Steel Desk - Wood Office Desk", image: "https://homesourcetx-wpengine.netdna-ssl.com/wp-content/uploads/2021/02/Industrial-and-wooden-desk.jpg", price: 175.00, description: "This table is handcrafted with reclaimed wood.")
product3 = Product.create(title: "Wood Table Lamp", image: "https://media.istockphoto.com/photos/yellow-artistic-lamp-with-rock-and-wooden-basement-on-the-table-picture-id1127365483?k=20&m=1127365483&s=170667a&w=0&h=mMKNACPJma1MCZPKJJsIZFzUMkVjxSxihn65Al-Zjq0=", price: 112.40, description: "Table lamp provides warm lighting.")
